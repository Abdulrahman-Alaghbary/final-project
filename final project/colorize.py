...
DIR = r"C:\Users\Abdulrahman Alghbary\Desktop\Final_Project\Colorizing-black-and-white-images-using-Python-master"
...
cv2.imwrite(join("output/", basename(args["image"])), colorized)
